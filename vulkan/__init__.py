...
VK_DEBUG_REPORT_OBJECT_TYPE_EXT__END_RANGE = 28
VK_DEBUG_REPORT_OBJECT_TYPE_QUEUE_EXT = 4
VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_LAYOUT_EXT = 17
VK_DEBUG_REPORT_OBJECT_TYPE_PHYSICAL_DEVICE_EXT = 2
VK_DEBUG_REPORT_OBJECT_TYPE_PIPELINE_EXT = 19
VK_DEBUG_REPORT_OBJECT_TYPE_FENCE_EXT = 7
VK_DEBUG_REPORT_OBJECT_TYPE_EXT__RANGE_SIZE = 29
...
def _external_vkVoidFunction(*args, **kwargs):
    return _internal_vkVoidFunction(*args, **kwargs)
_internal_vkReallocationFunction = None

@ffi.callback('PFN_vkReallocationFunction')
def _external_vkReallocationFunction(*args, **kwargs):
    return _internal_vkReallocationFunction(*args, **kwargs)
_internal_vkFreeFunction = None

@ffi.callback('PFN_vkFreeFunction')
def _external_vkFreeFunction(*args, **kwargs):
    return _internal_vkFreeFunction(*args, **kwargs)
_internal_vkAllocationFunction = None

@ffi.callback('PFN_vkAllocationFunction')
def _external_vkAllocationFunction(*args, **kwargs):
    return _internal_vkAllocationFunction(*args, **kwargs)
_internal_vkInternalFreeNotification = None

@ffi.callback('PFN_vkInternalFreeNotification')
def _external_vkInternalFreeNotification(*args, **kwargs):
    return _internal_vkInternalFreeNotification(*args, **kwargs)
_internal_vkInternalAllocationNotification = None

@ffi.callback('PFN_vkInternalAllocationNotification')
def _external_vkInternalAllocationNotification(*args, **kwargs):
    return _internal_vkInternalAllocationNotification(*args, **kwargs)
_internal_vkDebugReportCallbackEXT = None

@ffi.callback('PFN_vkDebugReportCallbackEXT')
def _external_vkDebugReportCallbackEXT(*args, **kwargs):
    return _internal_vkDebugReportCallbackEXT(*args, **kwargs)
...
def vkDestroyInstance(instance,pAllocator=None,):
...
def vkDestroyDevice(device,pAllocator=None,):
...
def vkFreeMemory(device,memory,pAllocator=None,):
...
def vkDestroyFence(device,fence,pAllocator=None,):
...
def vkDestroySemaphore(device,semaphore,pAllocator=None,):
...
def vkDestroyEvent(device,event,pAllocator=None,):
...
def vkDestroyQueryPool(device,queryPool,pAllocator=None,):
...
def vkDestroyBuffer(device,buffer,pAllocator=None,):
...
def vkDestroyBufferView(device,bufferView,pAllocator=None,):
...
def vkDestroyImage(device,image,pAllocator=None,):
...
def vkDestroyImageView(device,imageView,pAllocator=None,):
...
def vkDestroyShaderModule(device,shaderModule,pAllocator=None,):
...
def vkDestroyPipelineCache(device,pipelineCache,pAllocator=None,):
...
def vkDestroyPipeline(device,pipeline,pAllocator=None,):
...
def vkDestroyPipelineLayout(device,pipelineLayout,pAllocator=None,):
...
def vkDestroySampler(device,sampler,pAllocator=None,):
...
def vkDestroyDescriptorSetLayout(device,descriptorSetLayout,pAllocator=None,):
...
def vkDestroyDescriptorPool(device,descriptorPool,pAllocator=None,):
...
def vkDestroyFramebuffer(device,framebuffer,pAllocator=None,):
...
def vkDestroyRenderPass(device,renderPass,pAllocator=None,):
...
def vkDestroyCommandPool(device,commandPool,pAllocator=None,):
...
def vkCmdDispatch(commandBuffer,x,y,z,):
    result = _callApi(_lib.vkCmdDispatch, commandBuffer,x,y,z)
...
def _wrap_vkDestroySurfaceKHR(fn):
    def vkDestroySurfaceKHR(instance,surface,pAllocator=None,):
...
def _wrap_vkDestroySwapchainKHR(fn):
    def vkDestroySwapchainKHR(device,swapchain,pAllocator=None,):
