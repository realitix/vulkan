...
class HelloTriangleApplication(QtGui.QWindow):
    ...
    def __init__(self, screen=None):
        super(HelloTriangleApplication, self).__init__(screen)
    ...
    def __createInstance(self):
        ...
        ext = [ffi.new('char[]', i.encode()) for i in extensions]
        ...
        if enableValidationLayers:
            ...
            layers = [ffi.new('char[]', i.encode()) for i in validationLayers]
    ...
    def __createLogicalDevice(self):
        ...
        deArray = [ffi.new('char[]', i.encode()) for i in deviceExtensions]
